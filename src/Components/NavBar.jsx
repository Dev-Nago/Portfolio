  ...
  return (
    <div className='h-24 bg-black text-white flex flex-row'>
      ...
      <i className={isOpen ? 'fa-solid fa-x text-2xl m-auto hover:cursor-pointer' : 'fa-solid fa-bars m-auto text-2xl hover:cursor-pointer'} onClick={toggle}></i>
        <div className={isOpen ? 'z-40 h-screen w-screen bg-black fixed left-0 flex flex-col ease-in-out duration-500 sm:w-96' : 'h-screen w-screen bg-black fixed flex flex-col -left-full ease-in-out duration-500 sm:w-96'} onClick={toggle}>
