    ...
    <div className={isDarkMode ? "dark" : "light"}>
      <div className="text-2xl flex flex-row justify-center">
        ...
        <a href="https://github.com/Dev-Nago" target="blank_" rel="noreferrer">
          <i className="fa-brands fa-github flex m-5 my-16  hover:text-orange-400 hover:scale-125 transition duration-300"></i>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <i className="fa-brands fa-linkedin flex m-5 my-16 hover:text-orange-400 hover:scale-125 transition duration-300"></i>
        </a>
        <a href="mailto:pro.plaiajc@gmail.com" target="blank_" rel="noreferrer">
          <i className="fa-solid fa-envelope flex m-5 my-16 hover:text-orange-400 hover:scale-125 transition duration-300"></i>
        </a>
      </div>
