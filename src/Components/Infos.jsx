  ...
  return (
    <div className="h-screen text-black" id="Infos">
      <div className="h-screen flex flex-col justify-center items-center">
        ...
        <p className="font-mono text-lg m-5 max-w-5xl">Je suis actuellement en formation de développeur IA/Data avec Ecole IA MICROSOFT by Simplon.co et je recherche une Alternance dans le domaine pour mi Février 2025.</p>
      </div>
    </div>
  );
}
