  ...
  return (
    <div className="h-screen text-black" id="Infos">
      <div className="h-screen flex flex-col justify-center items-center">
        ...
        <p className="font-mono text-lg m-5 max-w-5xl">Je suis actuellement en formation de développeur IA/Data chez Simplon.co et je recherche une Alternance en Développement IA / Data Analyst pour Mars 2025.</p>
      </div>
    </div>
  );
}
